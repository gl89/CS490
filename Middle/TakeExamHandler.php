...
$output = $OE;
    ...
    $method_pattern = '/[a-z]+\(/'; //  '\(' is boundary, as in method_name '(...' Capture just the name of the method.
...
#echo $java_output;
    ...
    curl_setopt($crl, CURLOPT_URL, "http://web.njit.edu/~ovl2/CS490/Back/grading.php");
